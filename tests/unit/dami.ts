...
Rhum.testPlan("tests/unit/dami.ts", () => {
  Rhum.testSuite("constructor()", () => {
    Rhum.testCase("Sets the configs correctly when all props are passed in", () => {

    })
    Rhum.testCase("Sets the configs correctly when some props are passed in", () => {

    })
    Rhum.testCase("Defaults to `defaultConfigs` when no configs were passed in", () => {
  ...
  Rhum.testSuite("on()", () => {
    Rhum.testCase("Listens for and receives an event for the event type", () => {
